...
export default function ClueGuessGamePage() {
  ...
  return (
    <motion.main
      ...
      className="mx-auto min-h-screen max-w-5xl px-4 pb-10 pt-6"
    >
      ...
      <header className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="grid grid-cols-3 gap-3 rounded-xl border border-mid/60 bg-deep/70 px-4 py-2.5 sm:min-w-80">
          <div>
